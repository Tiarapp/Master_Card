    ...
    */
    ...
    'connections' => [
        ...
        'fbteknik' => [
            ...
            'database' => env('DB_DATABASE1', 'D:\TES_DELPHI\FBDB\TEKNIK_INDUK_SPA.FDB'),
        ...
        'fbbp' => [
            ...
            'database' => env('DB_DATABASE3', 'D:\TES_DELPHI\FBDB\BP_CONVERTING_SPA.FDB'),
        ...
        'firebird' => [
            ...
            'database' => env('DB_DATABASE4', 'D:\DB\Database\FBDB\MASTER_SPA.FDB'),
        ...
        //     'database' => env('DB_DATABASE5', 'D:\TES_DELPHI\FBDB\BJ_CONVERTING_SPA-NEW.FDB'),
        ...
        'firebird2' => [
            ...
            'host'     => env('DB_HOST5', '192.168.1.250'),
            'port'     => env('DB_PORT5', '3050'),
            'database' => env('DB_DATABASE5', 'D:\DB\Database\FBDB\BJ_CONVERTING_SPA-2025.FDB'),
            'username' => env('DB_USERNAME5', 'sysdba'),
            'password' => env('DB_PASSWORD5', 'masterkey'),
            'charset'  => env('DB_CHARSET', 'UTF8'),
            'version'  => env('DB_VERSION', '2.5'), // Supported versions: 2.5, 1.5
        ...
        'stationary' => [
            ...
            'host'     => env('DB_HOST5', '192.168.1.250'),
            'port'     => env('DB_PORT5', '3050'),
            'database' => env('DB_DATABASE5', 'D:\TES_DELPHI\FBDB\STATIONARY_SPA.FDB'),
            'username' => env('DB_USERNAME5', 'sysdba'),
            'password' => env('DB_PASSWORD5', 'masterkey'),
            'charset'  => env('DB_CHARSET', 'UTF8'),
            'version'  => env('DB_VERSION', '2.5'), // Supported versions: 2.5, 1.5
