...
class CreateMcView extends Migration 
{
    public function up()
    {
        DB::statement("CREATE VIEW mc_view AS SELECT 
                        ...
                        bx.beratSheetBox as berat_sheet_box,
                        stnBeratSheetBox.nama as satuan_berat_sheet_box,
                        bx.nama as nama_box,
                        ...
                        LEFT JOIN satuan as stnBeratSheetBox ON bx.satuanBeratSheetBox = stnBeratSheetBox.id
