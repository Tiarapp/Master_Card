    ...
    <div class="content-header">
        <div class="row" id="form_list_mc">
            <div class="col-md-12">
                ...
                <form action="{{ route('kontrak.store_realisasi') }}"  method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="hidden" class="form-control txt_line" name="idkontrak" id="idkontrak" value="{{ $kontrak_M->id }}">
                                                <input type="text" class="form-control txt_line" name="noKontrak" id="noKontrak" value="{{ $kontrak_M->kode }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control txt_line" name="noKontrak" id="noKontrak" value="{{ $kontrak_M->customer_name }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control txt_line" name="qtyKirim" id="qtyKirim">
