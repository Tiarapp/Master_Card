      ...
      <form id="jquery-val-form" action="{{ route('kontrak.edit_kirim', $data->id) }}" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" name="tglKirim" id="tglKirim" value="{{ $data->tanggal_kirim }}" required>
            </div>
            <div class="mb-3">
              <label for="message-text" class="col-form-label">Jumlah Kirim:</label>
              <input type="number" class="form-control" name="jumlahKirim" id="jumlahKirim" value="{{ $data->qty_kirim }}" required>
            </div>
        </div>
