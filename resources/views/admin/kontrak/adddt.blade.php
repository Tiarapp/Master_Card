    ...
    <div class="modal-content">
      ...
      <form id="jquery-val-form" action="{{ route('kontrak.store_dt') }}" onsubmit="return validateForm()" method="post">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control" name="idkontrakm" id="idkontrakm" value="{{ $kontrak_D->kontrak_m_id }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="sisa" id="sisa" value="{{ $kontrak_D->pcsSisaKontrak }}" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="hidden" class="form-control" name="sisaKontrak" id="sisaKontrak" value="{{ $kontrak_D->pcsSisaKontrak }}">
