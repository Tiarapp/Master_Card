    ...
    <div class="content-header">
        <div class="row" id="form_list_mc">
            <div class="col-md-12">
                ...
                <form action="../prosesbbk/{{ $rolld->id }}" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tanggal BBK</label>
                                        <input type="date" class="form-control txt_line" name="tglbbk" id="tglbbk" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label>No OPI</label>
                                            <input type="text" class="form-control txt_line" name="noopi" id="noopi" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Subs</label>
                                        <input type="text" class="form-control txt_line" name="subs" id="subs" required >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
