    ...
    <div class="content-header">
        <div class="row" id="form_list_mc">
            <div class="col-md-5">
                ...
                <form action="{{ route('oproll.store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Kode</label>
                                <input type="text" class="form-control txt_line" name="kodebrg" id="kodebrg" value="{{ $roll->KodeBrg }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control txt_line" name="namabrg" id="namabrg" value="{{ $roll->NamaBrg }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Opname (Kg)</label>
                                <input type="text" class="form-control txt_line" name="opnamekg" id="opnamekg" onchange="getPcs()">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <button type="submit" class="btn btn-primary"><a href="{{ route('oproll.index') }}" style="color:white;">Back</a></button>
                        </div>
                    </div>
                </form>
            </div>
