            ...
            <div class="col-md-5">
                ...
                <form action="/admin/divisi/store" method="POST">
                    ...
                    <div class="row was-validated">
                        <div class="col-md-12" data-toggle="tooltip" data-placement="right" title="Input kode divisi">
                        ...
                        <div class="col-md-12" data-toggle="tooltip" data-placement="right" title="Input nama divisi">
                            <div class="form-group">
                                <label>Nama</label>
