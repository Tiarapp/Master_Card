            ...
            <div class="col-md-12">
                ...
                <form action="" >
                    ...
                    for ($i=0; $i < $count; $i++) {
                        ...
                        echo '<input type="text" name="idpalet['.$i.']" id="idpalet['.$i.']" value="'.$sj_Palet_D[$i]->namaBarang.'" readonly >' ;
                        echo '<input type="text" name="idpalet['.$i.']" id="idpalet['.$i.']" value="'.$sj_Palet_D[$i]->qty.'" readonly >' ;
                        echo '<input type="text" name="idpalet['.$i.']" id="idpalet['.$i.']" value="'.$sj_Palet_D[$i]->ukuran.'" readonly >' ;
                        echo '<input type="text" name="idpalet['.$i.']" id="idpalet['.$i.']" value="'.$sj_Palet_D[$i]->keterangan.'" readonly >' ;
                    }
                    ?>
                    <table class="table table-bordered" id="">
                        ...
                        <tbody>
                            ...
                            for ($i=0; $i<$counts; $i++) { 
                                ...
                                // dd($sj_Palet_D[$i]->namaBarang);
                                echo "<tr>";
                                    echo    "<td>";
                                        echo   "<select class='js-exaDple-basic-single col-md-12' name='nama_$i' id='nama_$i' onchange='getData();'>";
                                            echo   "<option value= >". $sj_Palet_D[1]->namaBarang ."|". $sj_Palet_D[0]->ukuran ."</option>";
                ...
                <script type="text/javascript">
                    ...
                    function getData() {
                        ...
                        if (data1 != '') {
                            ...
                            document.getElementById("ukuran[1]").value = $data[0];
                        } 
                        if (data2 != '') {
                            ...
                            document.getElementById("ukuran[2]").value = $data[1];
                        } 
                        if (data3 != '') {
