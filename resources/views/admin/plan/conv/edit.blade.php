                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" class="form-control txt_line" name="mesin" id="mesin" value="{{ $mesin->mesin }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control txt_line" name="kodeplan" id="kodeplan" value="{{ $data2->kode }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="date" class="form-control txt_line" name="tgl" id="tgl" value="{{ $data2->tanggal }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control txt_line" name="shift" id="shift" value="{{ $data2->shiftM }} ">
                                        </div>
                                        <div class="col-md-2">
                                          <label>Revisi</label>
                                      </div>
                                      <div class="col-md-4">
                                          <input type="text" class="form-control txt_line" name="revisi" id="revisi" >
                                      </div>
                                    </div>
                                </div>
                            </div>
