...
class QcController extends Controller
{
    ...
    public function edit($id) {
        ...
        $data = QcModel::where('testqc.id', '=', $id)
            ...
            ->select('testqc.*','opi_m.NoOPI as noopi', 'mc.flute', 'mc.gramSheetBoxKontrak2 as gram', 'mc.joint', 'box.panjangDalamBox as panjang', 'box.lebarDalamBox as lebar', 'box.tinggiDalamBox as tinggi', 'mc.panjangSheet', 'mc.lebarSheet')
            ->first();
